...
def gcd_of_last_digits(int_one, int_two)
  # your code goes here
  a = last_digit(int_one)
  b = last_digit(int_two)
  return a.gcd(b)
end
...
def dec_remainder_of_two_floats(f_dividend, f_divisor)
  # your code goes here
  x = f_dividend / f_divisor
  return x - f_quotient.floor
end
...
def dec_remainder_of_two_integers(i_dividend, i_divisor)
  ...
  return dec_remainder_of_two_floats(f_dividend, f_divisor)
end
